        ...
        <div className="contaner-form">
          ...
          >
            ...
            <select
              ...
              onChange={(e) => setEdit({ ...edit, rocketType: e.target.value })}
            >
       ...
       <div className="contaner-form">
          ...
          >
            <select
              name="destroyed"
              id="destroyed"
              value={edit.destroyed}
              onChange={(e) => setEdit({ ...edit, destroyed: e.target.value })}
            >
